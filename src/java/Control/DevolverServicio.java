    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if(request.getParameter("servicio") != null){
                String servicio = request.getParameter("listProv");
                String nickP = servicio.substring(0, servicio.lastIndexOf(","));
                String nombreA = servicio.substring(servicio.lastIndexOf(",")+1);
                ManejadorSQL.GetInstance().init("192.168.10.132");
                DtServicio s = ManejadorSQL.GetInstance().devolverServicio(nickP, nombreA);
